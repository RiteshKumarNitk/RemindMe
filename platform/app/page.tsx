  ...
  return (
    ...
    >
      ...
      <p style={{ color: "var(--ink-muted)", fontSize: 16, maxWidth: 520, margin: "0 0 32px" }}>
        This is the backend for DoseWise clinics — auth, tenancy, scheduling
        and the clinic queue, built as a REST API. The web dashboards
        (patient / doctor / reception / admin) are a later phase; this
        service has no screens of its own yet beyond this status page.
      </p>
