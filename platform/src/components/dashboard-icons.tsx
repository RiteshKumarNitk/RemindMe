...
/**
 * A small, fixed icon set for the dashboard shell (sidebar nav, topbar,
 * notification bell). Deliberately not a generic icon library dependency —
 * this is the exact set the shell uses, nothing more.
 */
...
export function PillIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon {...props}>
      <path d="M10.5 20.5 3.5 13.5a5 5 0 1 1 7-7l1.5 1.5 1.5-1.5a5 5 0 1 1 7 7l-7 7Z" />
    </Icon>
  );
}
...
const NAV_ICONS: Record<string, (props: SVGProps<SVGSVGElement>) => React.JSX.Element> = {
  Overview: GridIcon,
  Appointments: CalendarIcon,
  "My appointments": CalendarIcon,
  Queue: ClockIcon,
  Patients: UsersIcon,
  Doctors: UsersIcon,
  Staff: UsersIcon,
  Team: UsersIcon,
  "Family access": UsersIcon,
  Profile: BuildingIcon,
...
export function navIconFor(label: string) {
  return NAV_ICONS[label] ?? GridIcon;
}
